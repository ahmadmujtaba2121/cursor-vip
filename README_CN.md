...
方式1：通过 ghp.ci 代理脚本
bash
bash <(curl -Lk https://ghp.ci/https://github.com/kingparks/cursor-vip/releases/download/latest/install.sh) 9747254c5a04db07aea026a845186e42
```
方式2：通过 GitHub 脚本
```bash
bash <(curl -Lk https://github.com/kingparks/cursor-vip/releases/download/latest/i.sh) 9747254c5a04db07aea026a845186e42
```
方式3：手动下载二进制文件
...
cursor-vip 9747254c5a04db07aea026a845186e42
...
1. clone 该仓库后，替换 `README` 中的设备码为您的设备码。
...
分享你的推广链接：
```
https://cursor.jeter.eu.org?p=9747254c5a04db07aea026a845186e42
```
